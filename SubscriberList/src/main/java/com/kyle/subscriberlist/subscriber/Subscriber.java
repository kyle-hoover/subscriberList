...
@Entity
public class Subscriber {	//Subscriber class has to match name of file
	...
	public Subscriber(String firstName, String lastName, String userName, Date signedUp) {
		this.firstName = firstName;	//we use .this here because we already defined these up top!
	...
	//toString used for debugging - prints to console
